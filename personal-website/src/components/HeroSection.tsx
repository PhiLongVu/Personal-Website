      ...
      <div className="container max-w-4xl max-auto text-center z-10">
        <div className="flex flex-col gap-y-2">
          <h1 className="text-4xl md:text-6xl font-bold tracking-tight">
            ...
            <span className="ml-2 opacity-0 animate-fade-in-delay-2"> Vu</span>
          </h1>

          <p className="text-lg md:text-xl text-foreground max-h-2xl mx-auto opacity-0 animate-fade-in-delay-3">
